...
public class i7AWF {
    ...
    /** Creates a new instance of i7AWF */
    public i7AWF(String artist, String album) {
        this.artist = artist;
        this.album = album;
...
class i7AWFDemo {
    ...
    public i7AWFDemo(Object... options) {
    ...
    public static void main(String[] args) {
        ...
        new i7AWF("Portishead", "Portishead").writeToFile("Portishead - Portishead.jpg");
        new i7AWF("Miles Davis", "Birth of the Cool").writeToFile("Miles Davis - Birth of the Cool.jpg");
    }
}
