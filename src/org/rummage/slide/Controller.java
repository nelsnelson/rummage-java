    ...
    implements TransferDelegate
{
    ...
    final private void doCommand0(Command command) {
        ...
        if (command.equals("Exit")) {
            ...
            view.getToolBar().setVisible(!view.getToolBar().isVisible());
        }
        else if (command.equals("Status Bar")) {
            view.getStatusBar().setVisible(!view.getStatusBar().isVisible());
        }
