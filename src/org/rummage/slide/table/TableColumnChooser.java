...
public class TableColumnChooser extends MouseAdapter implements ActionListener{ 
    ...
    public void actionPerformed(ActionEvent ae){ 
        ...
        if(item.isSelected()){ 
            ...
            if (columnIndex.intValue() < table.getColumnCount()) {
                table.moveColumn(table.getColumnCount() - 1,
            ...
            for(int i = 0; i < columnModel.getColumnCount(); i++){ 
                ...
                if(col.getModelIndex() == columnIndex.intValue()){ 
                    item.putClientProperty(COLUMN_INDEX,
                        new Integer(columnIndex.intValue())); 
