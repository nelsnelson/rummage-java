...
package org.rummage.sun.awt.shell;
...
class DefaultShellFolder extends ShellFolder {
	...
	public static final String FILE_FOLDER_TYPE = "File Folder";
    ...
    public String getFolderType() {
        if (isDirectory()) {
            return FILE_FOLDER_TYPE; // TODO : LOCALIZE THIS STRING!!!
        } else {
            return FILE_TYPE; // TODO : LOCALIZE THIS STRING!!!
        }
    }
